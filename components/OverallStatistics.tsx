...
import { Lesson, Language, StudyData } from '../types';
import { CheckCircle2, Clock, ChevronRight, Eye, Info, BookOpen } from 'lucide-react';
...
const OverallStatistics: React.FC<Props> = ({ lang, lessons, allData, onReview, onGoToLesson }) => {
                ...
                return (
                  <tr key={lesson.id} className="group hover:bg-gray-50/50 transition-colors">
                    <td className="px-8 py-6 align-top">
                      <span className="w-10 h-10 rounded-xl bg-gray-100 text-[#1A2B3C] flex items-center justify-center font-black text-[16px] group-hover:bg-blue-600 group-hover:text-white transition-all">
                        {lesson.id}
                      </span>
                    </td>
